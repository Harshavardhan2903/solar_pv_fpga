...
HD_PWD='C:/Users/sirha/OneDrive/Desktop/electronics/internship/winter_24/solar_pv_module/solar_pv_module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solar_pv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solar_pv.tcl
