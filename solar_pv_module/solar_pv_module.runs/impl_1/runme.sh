...
HD_PWD='C:/Users/sirha/OneDrive/Desktop/electronics/internship/winter_24/solar_pv_module/solar_pv_module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log solar_pv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source solar_pv.tcl -notrace
